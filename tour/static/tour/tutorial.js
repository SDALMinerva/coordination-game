function startDiscussIntro() {   
    ...
    intro.addSteps([
      ...
      },
      {
        ...
        intro: "You will have one last chance to review your posts.",
        disableInteraction: true,
      },
      {
        element: document.querySelectorAll('.next-button')[0],
        intro: "Click Continue to move to the next page in the tour.",
      },
    ]);
  ...
  function startDecideIntro() {   
    ...
    intro.addSteps([
      ...
      {
        element: document.querySelectorAll('.next-button')[0],
        intro: "Next, you will play test rounds and when you are comfortable, begin the game. Click 'Next' to continue.",
      },
    ]);
