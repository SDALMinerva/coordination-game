...
$('.page-header').append(
  '<ul id="help-nav" class="nav pull-right">' +
    ...
    '<li class="no-hover nav-item pull-right">' + 
  	...
  	'</li>' +
  	'<li class="no-hover nav-item pull-right">' +
    	'<a id="tour-nav" class="nav-link clicktrack" href="javascript:void(0);" onclick="startDiscussIntro();">Tour</a>' +
  	'</li>'+
  	'</ul>'
);
} else {
$('.page-header').append(
  '<ul id="help-nav" class="nav pull-right">' +
    ...
    '<li class="no-hover nav-item pull-right">' + 
  	...
  	'</li>' +
  	'<li class="no-hover nav-item pull-right">' +
    	'<a id="tour-nav" class="nav-link clicktrack" href="javascript:void(0);" onclick="startDecideIntro();">Tour</a>' +
  	'</li>'+
  	'</ul>'
);
}