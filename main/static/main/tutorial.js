var discussSteps = [
    {
        ...
        intro: "In each round, you will be assigned a randomly chosen identity (or avatar). " +
               "You will also see your threshold, for example, T=3 means a threshold of 3, and the summary of the possible earnings. " + 
...
var decideSteps = [
    {
        element: document.querySelectorAll('.wall-card')[0],
        intro: "On this screen, you will be able to view all of the posts from the other players, but you will not be able to send or receive any more posts. Now is your chance to review what your friends have told you before you make a decision below.",
        position: "top",
    },
    {
        element: document.querySelectorAll('#friendsDiv')[0],
...
function startDiscussTour() {
    var intro = introJs();
    intro.setOption('exitOnOverlayClick', false);
    intro.setOption('showStepNumbers', false);
    intro.addSteps(discussSteps);
    intro.addSteps([{
...
function startDiscussInstructions() {   
    var intro = introJs();
    intro.setOption('exitOnOverlayClick', false);
...
function startDecideTour() {   
    var intro = introJs();
    intro.setOption('exitOnOverlayClick', false);
    intro.setOption('showStepNumbers', false);
    intro.addSteps(decideSteps);
    intro.start();
}

function startDecideInstructions() {   
    var intro = introJs();
    intro.setOption('exitOnOverlayClick', false);
    intro.setOption('exitOnEsc', false);
    intro.setOption('showStepNumbers', false);
